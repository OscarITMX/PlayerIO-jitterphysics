...
namespace Jitter2D
{
    ...
    public class World
    {
        ...
        private Jitter2D.Collision.IslandManager islands = new IslandManager(new ResourcePool<CollisionIsland>());
        private ResourcePool<Arbiter> poolArbiter = new ResourcePool<Arbiter>();
        private ResourcePool<Contact> poolContact = new ResourcePool<Contact>();
        ...
        */
        ...
        {
            islands.Pool.ResetResourcePool();
            poolContact.ResetResourcePool();
            poolArbiter.ResetResourcePool();
        }
        ...
        /// </summary>
        /// <param name="body">The body which should be added.</param>
        public void TestBody(RigidBody body)
        {
            events.RaiseAddedRigidBody(body);
