...
namespace Jitter2D.LinearMath
{
    ...
    public struct JVector
    {
        ...
        /// </summary>
        public static JVector Zero
        {
            get
            {
                return new JVector(0, 0);
            }
        }
        /// <summary>
        /// A vector with components (1,0);
        /// </summary>
        public static JVector Left
        {
            get
            {
                return new JVector(1, 0);
            }
        }
        /// <summary>
        /// A vector with components (-1,0);
        /// </summary>
        public static JVector Right
        {
            get
            {
                return new JVector(-1, 0);
        ...
        /// </summary>
        public static JVector Up
        {
            get
            {
                return new JVector(0, 1);
            }
        }
        /// <summary>
        /// A vector with components (0,-1);
        /// </summary>
        public static JVector Down
        {
            get
            {
                return new JVector(0, -1);
        ...
        /// </summary>
        public static JVector MinValue
        {
            get
            {
                return new JVector(float.MinValue);
            }
        }
        /// <summary>
        /// A vector with components 
        ...
        /// </summary>
        public static JVector MaxValue
        {
            get
            {
                return new JVector(float.MaxValue);
            }
        }
        #endregion
