...
namespace Jitter2D.Dynamics
{
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        public RigidBody(CommonData commonData, Shape shape)
            : this(commonData, shape, new Material(), false)
        {
        ...
        public RigidBody(CommonData commonData, Shape shape, Material material)
            : this(commonData, shape, material, false)
        {
        }
        ...
        public object TagOptHolder { get; set; }
        ...
        //var radians = refbody.orientation;
        //double degrees = (180 / System.Math.PI) * radians;

        public float GetAngleInDegrees()
        {
            var radians = orientation;
            float degrees = (180f / ((float)System.Math.PI)) * radians;
            return degrees;
        }
        ...
        //    JVector topRightCornerLocalPos = box.GetCorner(2);
        ...
        //    JVector.Transform(ref topRightCornerLocalPos, ref xform, out topRightCornerLocalPos);
        ...
        //    //a += this.position;
        //    //b += this.position;
        //    topRightCornerLocalPos += this.position;
        //    //d += this.position;


        //    //VectorHelper.GetAngle()
