...
namespace Jitter2D.Dynamics
{
    ...
    public class Arbiter
    {
        ...
        /// <summary>
        /// </summary>
        public ResourcePool<Arbiter> poolArbiter;
        public ResourcePool<Contact> poolContact;
        ...
        public void Prepare(ResourcePool<Arbiter> poolArbiter, ResourcePool<Contact> poolContact)
        {
            this.poolArbiter = poolArbiter;
